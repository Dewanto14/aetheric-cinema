          ...
          <>
            ...
            <div className="relative z-10 p-6 md:p-12 lg:p-container-padding max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
                ...
                <Link to={`/tv/${trending[0].id}`} className="glass-panel text-on-surface px-6 md:px-8 py-3 rounded-full font-body-md font-bold flex items-center justify-center gap-2 bloom-hover">
